...
status: verified
---
# Variants and edge boundaries

## Source-backed facts

- Claim: The manual provides a two-player variant rather than treating two players as the standard setup.
  Source: src-002
  Evidence: The manual's contents list Playing with Two Players on printed page 19, while the overview marks the standard game as 3–5 players.
  Confidence: high
- Claim: The manual also provides a five-player variant with altered dealing or task handling.
  Source: src-002
  Evidence: The contents list Playing with Five Players on printed page 18, and the variant section supplies the additional procedure.
  Confidence: high
- Claim: Color distinction is supported by alternate symbols on cards for players who need them.
  Source: src-002
  Evidence: Manual printed page 3 assigns each color a symbol and presents the symbols as an aid when colors are difficult to distinguish.
  Confidence: high
