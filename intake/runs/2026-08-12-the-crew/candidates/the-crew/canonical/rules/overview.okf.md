...
- Claim: The Crew is a cooperative, mission-based trick-taking game.
  Source: src-002
  Evidence: Manual printed page 3, Game Overview, uses that classification and explains that the crew succeeds or fails together.
  Confidence: high
- Claim: The base component framework includes 40 large playing cards, 36 task cards, reminder cards, and 16 tokens.
  Source: src-002
  Evidence: Manual printed page 2, Game Materials, lists 40 large cards, 36 small task cards, 5 reminder cards, and 16 tokens.
  Confidence: high
- Claim: The game is organized as a 50-mission journey whose challenges change by mission.
  Source: src-002
  Evidence: Manual printed page 3 says the journey spans 50 different missions with unique win conditions.
  Confidence: high
