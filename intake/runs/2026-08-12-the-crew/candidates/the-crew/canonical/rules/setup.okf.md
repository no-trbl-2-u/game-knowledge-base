...
- Claim: Setup begins by shuffling the 40-card playing deck and distributing it among players.
  Source: src-002
  Evidence: Manual printed Game Overview and mission-preparation sections describe shuffling the deck and dealing the full deck.
  Confidence: high
- Claim: The player who receives the rank-4 rocket becomes commander for the mission.
  Source: src-002
  Evidence: Manual printed page 8, Mission Preparation & Sequence, identifies the holder of the 4 rocket as commander and uses the commander token.
  Confidence: high
- Claim: Task cards are selected and assigned before the commander starts the first trick.
  Source: src-002
  Evidence: Manual printed page 8 describes drawing task cards, assigning them in commander order, and then beginning the mission sequence.
  Confidence: high
