...
This record covers the Universal Monsters base game only. The publisher identity page and official ES01 instructions are separate receipts; the packet does not collapse language, product, or title boundaries.

## Source-backed facts

- Claim: The publisher identifies the product as Horrified: Universal Monsters, article 60001836, EAN 810558018361, licensed Universal Monsters, and a 1–5 player strategy game.
  Source: src-001
  Evidence: Archived Ravensburger product page, product information and structured product description.
  Confidence: high
- Claim: The official instructions describe a cooperative game in which players defeat all selected monsters to win, with terror and an exhausted monster deck as loss conditions.
  Source: src-002
  Evidence: Official instructions printed pp. 5 and 9; the objective begins “«Horrified» es un juego cooperativo” and the end section defines the three endings.
  Confidence: high
- Claim: The rules use action-limited hero turns, item collection and sharing, monster-specific tasks, and a card-driven monster phase.
  Source: src-002
  Evidence: Official instructions printed pp. 5–8.
  Confidence: high
