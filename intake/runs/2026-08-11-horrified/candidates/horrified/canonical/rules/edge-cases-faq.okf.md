...
# Clarifications and solo rules

## Source-backed facts

- Claim: The appendix distinguishes movement along paths from placement, and defines “person” as hero or villager and “monster” as any of the seven Universal Monsters characters in the game.
  Source: src-002
  Evidence: Official instructions printed p. 15, “Aclaraciones — Términos.”
  Confidence: high
- Claim: Players need permission before moving or affecting another player’s hero or objects, and special actions/cards still follow normal movement constraints.
  Source: src-002
  Evidence: Official instructions printed p. 15, “Héroes y cartas de ventaja.”
  Confidence: high
- Claim: Solo play starts terror at 3 and removes the Messenger hero and two named Perk cards from the available solo procedure.
  Source: src-002
  Evidence: Official instructions printed p. 15, “Juego en solitario.”
  Confidence: high
