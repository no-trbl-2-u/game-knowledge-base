...
sources:
  - id: "src-001"
    ...
    notes: "Archived publisher replay 2025-11-04 retrieved HTTP 200; 627,928 bytes; SHA-256 e7705b3facc3ae5f9e84b72ebbf683fef1cb9c0097cb33fcf6d9636c6aabda48. Direct current page returned HTTP 403. Article 60001836, EAN 810558018361, Universal Monsters licence, 1–5 players, and product description were inspected."
  - id: "src-002"
...
- Claim: A player turn has a Hero Phase followed by a Monster Phase.
  Source: src-002
  Evidence: Official instructions printed p. 5.
  Confidence: high
- Claim: During the Hero Phase, a hero performs no more than the action count shown on the hero badge, may repeat actions in any order, and may play any number of Perk cards during the Hero Phase.
  Source: src-002
  Evidence: Official instructions printed pp. 5–6.
  Confidence: high
- Claim: During the Monster Phase, the player draws the top monster card and resolves its three sections from top to bottom before discarding it.
  Source: src-002
  Evidence: Official instructions printed p. 8.
  Confidence: high
