...
- Claim: Setup uses the board, terror marker, villagers, dice, monster deck, selected monster panels, and selected-monster preparation instructions.
  Source: src-002
  Evidence: Official instructions printed p. 4, “Preparación para los monstruos.”
  Confidence: high
- Claim: Heroes are assigned randomly in the illustrated setup, receive their matching mover and aid card, and begin at the location shown on the hero badge.
  Source: src-002
  Evidence: Official instructions printed p. 4, “Preparación para los jugadores.”
  Confidence: high
- Claim: The object bag begins with 60 object tokens; twelve objects are drawn and placed at the locations shown on their tokens.
  Source: src-002
  Evidence: Official instructions printed p. 4 and component pages 2–3.
  Confidence: high
