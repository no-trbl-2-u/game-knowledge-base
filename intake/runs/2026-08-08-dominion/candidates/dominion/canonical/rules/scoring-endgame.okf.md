...
- Claim: The game ends at the end of a turn when either the Province pile is empty or any three or more Supply piles are empty.
  Source: src-002
  Evidence: Official rulebook printed page 6, End of the Game.
  Confidence: high
- Claim: Players count the Victory Points in their decks after the end trigger; the player with the most Victory Points wins.
  Source: src-002
  Evidence: Official rulebook printed pages 4 and 8, endgame and Victory Points reference.
  Confidence: high
- Claim: Victory cards can be strategically awkward during play because they occupy deck space without providing ordinary action or Treasure effects, while still being required for final scoring.
  Source: src-002, src-003
  Evidence: Official rulebook’s card-type explanation and Board Game Quest’s Game Overview discussion of balancing action, Victory, and currency cards.
  Confidence: medium
