...
- Claim: Each player shuffles a starting deck of 3 Estates and 7 Coppers.
  Source: src-002
  Evidence: Official rulebook printed page 3, setup instructions.
  Confidence: high
- Claim: The table receives 17 face-up Supply piles: seven base piles and ten Kingdom piles chosen for the current game.
  Source: src-002
  Evidence: Official rulebook printed page 3, Supply setup paragraph.
  Confidence: high
- Claim: Before first play, the component cards are sorted into the organizer by matching names and Randomizer cards are kept separate from playing cards.
  Source: src-002
  Evidence: Official rulebook printed pages 2–3, organizer and card-back handling instructions.
  Confidence: high
