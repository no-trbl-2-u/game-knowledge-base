...
//   /search/<scope>.txt  line-addressed body bundle, "path\tlineno\ttext"
...
// Module scope: warm for the life of the isolate, refetched after eviction.
// Every deploy replaces the isolate, so these can never go stale against the
// assets they were read from.
const cache = new Map()
