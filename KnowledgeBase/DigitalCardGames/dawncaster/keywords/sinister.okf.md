...
- **Ordinal:** 118 of 141
- **Type:** Effect
- **Functions:** Buff, Deck Management

## Source-backed facts

- Claim: `Sinister` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Sinister cards get more powerful for each other Sinister card you played during the entire combat
