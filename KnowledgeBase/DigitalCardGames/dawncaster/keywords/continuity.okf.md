...
- Claim: `Continuity` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Triggers when played after a card of the same type (melee, magic, ranged, divine). (Reliable cards also trigger this effect)
