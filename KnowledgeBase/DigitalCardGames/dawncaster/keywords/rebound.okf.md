...
- Claim: `Rebound` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Rebound counts the number of times you played the card, and triggers its special effect when the card has been played X number of times
