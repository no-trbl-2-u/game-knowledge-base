...
- Claim: `Challenger` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
A Challenger has to be selected first. Opportunities return to the area deck when a Challenger is selected
