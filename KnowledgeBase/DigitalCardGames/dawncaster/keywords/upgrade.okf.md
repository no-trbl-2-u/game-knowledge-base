...
- **Ordinal:** 135 of 141
- **Type:** Effect
- **Functions:** Upgrade, Offense

## Source-backed facts

- Claim: `Upgrade` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Upgraded cards deal 1 additional damage per upgrade. Generally, only cards that deal damage can be Upgraded, as well as cards with the Upgradeable effect
