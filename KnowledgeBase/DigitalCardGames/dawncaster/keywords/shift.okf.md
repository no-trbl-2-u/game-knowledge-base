...
- Claim: `Shift` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Assume a new Form. Only one Form can be active at a time: activating a new Form will replace the old one
