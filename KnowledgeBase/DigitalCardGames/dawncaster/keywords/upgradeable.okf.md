...
- **Ordinal:** 136 of 141
- **Type:** Effect
- **Functions:** Upgrade, Various

## Source-backed facts

- Claim: `Upgradeable` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
This card can be Upgraded, which improves the card in unusual ways
