...
- Claim: `Barrier` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
When dealt damage, take 1 less non-Piercing damage per stack of Barrier. Barrier does not fade, and can be Dispelled
