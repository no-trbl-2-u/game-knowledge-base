...
- **Ordinal:** 140 of 141
- **Type:** Affliction
- **Functions:** Debuff, Defense, Immunity

## Source-backed facts

- Claim: `Weakness` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
The next damage you deal is reduced by 50%. You can't inflict Critical Hits while affected by Weakness
