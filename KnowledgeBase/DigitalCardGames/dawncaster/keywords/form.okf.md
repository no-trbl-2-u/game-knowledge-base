...
- Claim: `Form` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Forms transform your appearance. Only 1 Form can be active at a time: activating a new Form will replace the old one
