...
- Claim: `Charges` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Cards with Charges can be played X number of times per combat before they become Depleted and are removed from combat
