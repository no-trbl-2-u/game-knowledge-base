...
- Claim: `Firecast` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
A card with Firecast is played and moved into the discard pile whenever it gets Buried on your turn
