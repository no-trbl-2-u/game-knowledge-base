...
- Claim: `One Use` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
This card will be permanently Removed from your deck after playing it, even if it has non-Removable properties such as Cursed
