...
- **Ordinal:** 87 of 141
- **Type:** Effect
- **Functions:** Deck Management, Upgrade, Offense

## Source-backed facts

- Claim: `Mergecraft` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
When Mergecraft cards are added to the deck, they Upgrade all copies of that card by their Mergecraft value
