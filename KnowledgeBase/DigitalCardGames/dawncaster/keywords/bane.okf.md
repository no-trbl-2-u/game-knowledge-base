...
- Claim: `Bane` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Whenever you gain an Affliction (except Dazzled, Jinxed or Shocked), gain an additional stack of that Affliction for each point of Bane
