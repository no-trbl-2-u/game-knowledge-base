...
- Claim: `Ascend` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Ascend to a higher form, gaining more powerful buffs for each Ascended level. You can Ascend up to 3 levels
