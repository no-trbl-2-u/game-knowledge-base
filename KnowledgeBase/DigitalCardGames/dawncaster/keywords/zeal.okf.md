...
- **Ordinal:** 141 of 141
- **Type:** Blessing
- **Functions:** Holy Energy

## Source-backed facts

- Claim: `Zeal` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
Your Divine actions deal additional damage for each Zeal. At the start of the turn, take damage equal to your Zeal
