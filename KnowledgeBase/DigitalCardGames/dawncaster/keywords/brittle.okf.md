...
- Claim: `Brittle` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
When dealt damage, remove Brittle. If the damage was dealt from a Melee Action, take 1 more damage per stack removed
