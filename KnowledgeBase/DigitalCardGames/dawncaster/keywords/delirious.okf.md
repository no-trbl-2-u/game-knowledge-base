...
- **Ordinal:** 42 of 141
- **Type:** Affliction
- **Functions:** Chaos, Energy Management

## Source-backed facts

- Claim: `Delirious` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
After playing a card, shuffle the costs of all cards in hand. Lasts 1 round per stack
