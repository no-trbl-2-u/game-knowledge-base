...
- Claim: `Doom` appears in the Dawncaster Wiki keyword table.
  Source: src-001
...
At the end of your turn, take 1 damage for each stack of Doom. Increase Doom by 1 each time an Action is played
