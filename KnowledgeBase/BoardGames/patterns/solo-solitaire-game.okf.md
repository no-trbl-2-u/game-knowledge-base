...
- elder-sign (src-002, src-004): solo play works without a separate automation system, leaning instead on lenient death penalties — RPGnet reports enjoying it "both in solo efforts and with others," while Opinionated Gamers notes "a solo player could simply burn through several characters in a single game" without harsh consequence. confidence: high
...
- elder-sign (src-002, src-004): solo play is explicitly enjoyed without any bolt-on automation system — the base ruleset alone supports a satisfying single-player session.
