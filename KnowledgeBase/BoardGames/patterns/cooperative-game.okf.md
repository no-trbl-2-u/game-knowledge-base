...
The reception docs with genuine co-op-dynamics commentary are heroes-of-terrinoth, mage-knight, slay-the-spire-the-board-game, and spirit-island. Other tagged records presently discuss deckbuilding, campaign structure, or onboarding rather than cooperation itself. The corpus would benefit from a game whose reviews explicitly discuss restricted-communication or hidden-information co-op design (e.g. a Hanabi-style limited-communication game) to broaden this pattern past quarterbacking/alpha-player commentary.
