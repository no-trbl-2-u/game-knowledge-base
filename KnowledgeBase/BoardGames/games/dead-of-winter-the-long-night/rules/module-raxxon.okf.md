...
scope: "edition-specific Raxxon module and Chimp and the Code scenario"
...
- Claim: Setup adds skull-and-crossbones cards, Raxxon with its 20-card search deck, the 12-card experiment deck Audio Logs side up, and the ordered six-card side-effect deck.
  Source: src-001
  Evidence: Rulebook p.18.
  Confidence: high

- Claim: Searching Raxxon triggers exposure after the search.
  Source: src-001
  Evidence: Rulebook p.18.
  Confidence: high

- Claim: Pill items may equip a named side-effect card after a die roll; side effects cannot be unequipped.
  Source: src-001
  Evidence: Rulebook p.18.
  Confidence: high

- Claim: Players can place matching action dice at Raxxon to vote on containing the top experiment; failure deploys its special zombies and encounter side.
  Source: src-001
  Evidence: Rulebook p.18.
  Confidence: high
