...
Open: full target-printing card/board/reference text and identities; authoritative proof that no target-specific FAQ/errata/module sheet exists outside the bounded Plaid Hat CDX inventory; and current FFG support content hidden behind HTTP 403. Therefore the governing denominator is `UNKNOWN`; no percentage or composite is claimed.
