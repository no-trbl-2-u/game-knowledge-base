...
mechanics: ["cooperative-game", "action-points", "hand-management", "set-collection", "variable-player-powers"]
sources:
  - id: "src-001"
    title: "BoardGameGeek — Pandemic"
    url: "https://boardgamegeek.com/boardgame/30549"
    kind: bgg_page
    provenance: community
    retrieved_at: "2026-07-29"
    asset_url: "https://boardgamegeek.com/boardgame/30549"
    notes: "Identity, year, mechanism, and rating-lead source; rating snapshot requires librarian recheck."
confidence: medium
status: needs_followup
last_verified: "2026-07-29"
summary: "Pandemic — bounded A cohort intake for deck/bag/dicebuilder."
---
# Pandemic

## Summary

Pandemic is catalogued for cooperative play. This bounded intake preserves an identity lead and a controlled-mechanics classification for follow-up research; it does not substitute the official rules.

## Source-backed facts

- Claim: BoardGameGeek identifies this title as a distinct board-game release associated with the cited year and BGG record.
  Source: src-001
  Evidence: "BoardGameGeek record 30549; page retrieved 2026-07-29."
  Confidence: medium

- Claim: The intake classification uses the mechanics listed in frontmatter: cooperative-game, action-points, hand-management, set-collection, variable-player-powers.
  Source: src-001
