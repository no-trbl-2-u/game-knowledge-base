...
- Claim: Dominion models a personal deck containing resources, Victory Points, and action options; the objective is the most Victory Points when the game ends.
  Source: src-002
  Evidence: Official rulebook printed page 1 describes the deck’s contents and the endgame objective.
  Confidence: high
- Claim: The current base-game component list contains 500 cards: 130 basic Treasures, 48 basic Victory cards, 30 Curses, 262 Kingdom cards, 26 Randomizers, and 4 blanks.
  Source: src-002
  Evidence: Official rulebook printed page 2, Components.
  Confidence: high
- Claim: The Supply is built from seven base piles and ten selected Kingdom piles, making the basic market configuration variable from game to game.
  Source: src-002
  Evidence: Official rulebook printed page 3 calls the seven base piles always used and the ten Kingdom piles variable.
  Confidence: high
