...
- Claim: The current official rulebook states that an Action card’s resolution is completed before the next Action is played, and that additional Actions increase the number of Action plays rather than interrupting the current card.
  Source: src-002
  Evidence: Official rulebook printed pages 4 and 7, +Action explanation.
  Confidence: high
- Claim: The current official rulebook treats played cards as in play until Clean-up unless a card says otherwise, and unused +Actions, +Buys, and spending do not carry over.
  Source: src-002
  Evidence: Official rulebook printed pages 5 and 7, phase and in-play handling.
  Confidence: high
- Claim: A community article titled “Dominion 2019 Errata and Rules Tweaks” was retrieved, but its card-specific changes are not imported as official current-print rules in this packet.
  Source: src-007
  Evidence: The retrieved article identifies itself as community content, carries a September 25, 2019 publication date, and attributes its opening statement to designer Donald X. Vaccarino; it is not the Rio Grande rulebook endpoint.
  Confidence: high

## FAQ/errata disposition

No separate official FAQ or errata claim is published. The official core rulebook is the bounded authority for every operative rule claim above; the community article is preserved only as a provenance boundary.
