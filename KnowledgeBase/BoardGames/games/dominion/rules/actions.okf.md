...
# Actions and card handling

## Source-backed facts

- Claim: An Action card is played from hand, announced, moved to the play area, and resolved from its text box; a normal turn begins with one Action play.
  Source: src-002
  Evidence: Official rulebook printed pages 4 and 6–7, Action phase and card-type reference.
  Confidence: high
- Claim: Action cards can grant additional Actions, Buys, cards, or spending, allowing combinations beyond the default single Action and single Buy.
  Source: src-002
  Evidence: Official rulebook printed pages 4–7 explain +Action, +Buy, +Cards, and extra spending.
  Confidence: high
- Claim: Trashing places a card face up on the Trash mat and removes it from the player’s deck unless an expansion effect retrieves it; this packet does not apply expansion retrieval rules.
  Source: src-002
  Evidence: Official rulebook printed pages 7–8 define “Trash a card” and the base-game boundary.
  Confidence: high
