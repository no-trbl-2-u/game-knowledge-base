...
# Travel, Quests, and Heroic Actions

- Claim: A move reaches any other Quest for one action regardless of map distance; Camelot's Round Table and Siege area interconnect freely. Black Knight and Lancelot are solo while in play; when the last Knight abandons a solo Quest, its White cards are discarded, whereas group-Quest White cards remain.
...
- Claim: In Camelot, later comparison permits drawing two White cards if beginning below twelve cards or fighting one Siege Engine by committing Fight cards then rolling the D8; committed total must exceed the die or the Knight loses one Life, and all committed cards discard.
  Source: src-002, src-003
  Evidence: FAQ section I hand-limit ruling; later rulebook p. 13.
  Confidence: medium

- Claim: Death at zero removes the Knight and discards White cards; Excalibur and Armor are lost, while a previously won Grail may restore that Knight to four Life once and end the turn. Loyalty stays concealed on death.
  Source: src-001, src-002, src-003
  Evidence: Book of Quests relic/Traitor appendices; FAQ sections V-VI; later rulebook p. 12.
  Confidence: medium
