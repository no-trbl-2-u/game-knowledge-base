...
# Turn structure
- Claim: Each location-page round has Planning, Action, and End of Round phases in that order.
  Source: src-001
  Evidence: Rulebook p.5 Playing a Round.
  Confidence: high
- Claim: Planning is timed but selection proceeds highest-to-lowest infamy; timeout adds one discontent and selection continues.
  Source: src-001
  Evidence: Rulebook p.5 Planning Phase.
  Confidence: high
- Claim: Actions resolve by printed action number, then by higher-to-lower infamy among pirates sharing that number.
  Source: src-001
  Evidence: Rulebook p.5 Action Phase.
  Confidence: high
- Claim: End of Round reads the keyed entry printed on the current page.
  Source: src-001
  Evidence: Rulebook p.5 End of Round Phase.
  Confidence: high
- Claim: Despite time pressure and overlapping deliberation, the formal placement order is sequential, so this record does not tag simultaneous-action-selection.
  Source: src-001
  Evidence: Rulebook requires placement “in order from highest to lowest infamy.”
  Confidence: high
