...
# Success, loss, and endings
- Claim: Hull at zero, discontent equal to or above crew, or the final threat event makes every player lose.
  Source: src-001
  Evidence: Rulebook p.5 Winning and Losing.
  Confidence: high
- Claim: When a scenario entry declares the goal reached, a pirate with at least four completed constellation events wins individually; five is a superior victory.
  Source: src-001
  Evidence: Rulebook p.5 Scenario Goal Reached.
  Confidence: high
- Claim: Endings are read from personal sheets in descending infamy order after scenario resolution; this record does not reproduce them.
  Source: src-001, src-002
  Evidence: Rulebook p.5 directs sheet ending lookup; replacement PDF contains copyrighted ending prose.
  Confidence: high
- Claim: The design combines collective loss with individual qualification rather than conventional point scoring.
  Source: src-001
  Evidence: Four enumerated end conditions and constellation thresholds.
  Confidence: high
