...
summary: "Cooperative fantasy campaign about apprentices training to become breach mages and defend Gravehold from the Nameless; the base Aeon's End is not required."
---

# Rules overview — Aeon's End: Legacy

## Source-backed facts

- Claim: Cooperative fantasy campaign about apprentices training to become breach mages and defend Gravehold from the Nameless; the base Aeon's End is not required.
  Source: src-002
