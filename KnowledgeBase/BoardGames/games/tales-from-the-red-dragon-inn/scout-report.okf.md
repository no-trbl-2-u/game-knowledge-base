...
game:
  ...
  slug: "tales-from-the-red-dragon-inn"
  bgg_id: 345976
...
mechanics: ["solo-solitaire-game", "campaign-game", "grid-movement", "variable-player-powers"]
sources:
  - id: "src-001"
    title: "BoardGameGeek — Tales from the Red Dragon Inn"
    url: "https://boardgamegeek.com/boardgame/345976"
    kind: bgg_page
    provenance: community
    retrieved_at: "2026-07-29"
    asset_url: "https://boardgamegeek.com/boardgame/345976"
...
followups:
  - source_id: null
    url: "https://www.example.invalid/tales-from-the-red-dragon-inn/official-rules"
    failure: not_found
...
Tales from the Red Dragon Inn is catalogued for solo or solo-capable character-driven play. This bounded intake preserves an identity lead and a controlled-mechanics classification for follow-up research; it does not substitute the official rules.

## Source-backed facts

- Claim: BoardGameGeek identifies this title as a distinct board-game release associated with the cited year and BGG record.
  Source: src-001
  Evidence: "BoardGameGeek record 345976; page retrieved 2026-07-29."
  Confidence: medium

- Claim: The intake classification uses the mechanics listed in frontmatter: solo-solitaire-game, campaign-game, grid-movement, variable-player-powers.
  Source: src-001
