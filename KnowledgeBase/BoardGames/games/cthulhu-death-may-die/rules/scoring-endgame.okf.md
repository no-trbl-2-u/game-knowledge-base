...
There is no point score. The cooperative end state is determined by the ritual, Elder One stages, investigator survival, and the summoning track.

## Source-backed facts

- Claim: Investigators win by defeating the Elder One's Final Stage.
  Source: src-002
  Evidence: Rulebook p. 19.
  Confidence: high
- Claim: Investigators lose if an investigator is eliminated before summoning, all investigators are eliminated after summoning, or the progression token reaches the final summoning-track space.
  Source: src-002
  Evidence: Rulebook p. 19.
  Confidence: high
- Claim: Excess wounds on a defeated Elder One Stage do not carry to the next Stage.
  Source: src-002
