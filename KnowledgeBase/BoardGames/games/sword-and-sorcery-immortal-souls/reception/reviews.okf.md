...
# Reviews — Sword & Sorcery: Immortal Souls

## Praised design

- Claim: The independent review confirms dedicated external coverage; the fetched video page supplied no transcript, so specific praise is limited to the source-backed AI, no-GM, no-elimination, and hero-growth dynamics.
  Source: src-005
...
- Claim: No review-text friction claim was extracted from the fetched video page; rules burden, scenario balance, and campaign length remain unknown in this batch.
  Source: src-005
  Evidence: Bathcat's source review supports this concise synthesis; consult the registry for retrieval limits.
  Confidence: low
