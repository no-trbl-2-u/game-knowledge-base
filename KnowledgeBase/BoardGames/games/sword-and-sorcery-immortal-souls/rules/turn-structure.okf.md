...
summary: "The mechanism profile uses action points, area movement, dice rolling, modular boards, and variable player powers; exact sequence was checked against the official rulebook as a source but not reproduced here."
---

# Turn structure — Sword & Sorcery: Immortal Souls

## Source-backed facts

- Claim: The mechanism profile uses action points, area movement, dice rolling, modular boards, and variable player powers; exact sequence was checked against the official rulebook as a source but not reproduced here.
  Source: src-002
