...
summary: "Up to five players control one or more heroes using modular boards, hero figures, cards, and scenario components; the game is designed for quests of about ninety minutes or less."
---

# Setup — Sword & Sorcery: Immortal Souls

## Source-backed facts

- Claim: Up to five players control one or more heroes using modular boards, hero figures, cards, and scenario components; the game is designed for quests of about ninety minutes or less.
  Source: src-002
