...
summary: "Cooperative fantasy adventure in which five heroes are restored from death to fight evil; it uses enemy AI, supports solo play, and requires no Game Master."
---

# Rules overview — Sword & Sorcery: Immortal Souls

## Source-backed facts

- Claim: Cooperative fantasy adventure in which five heroes are restored from death to fight evil; it uses enemy AI, supports solo play, and requires no Game Master.
  Source: src-002
