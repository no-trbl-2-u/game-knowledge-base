...
- 2026-08-12 (librarian pass): `src-004` retried via `curl -L`: still HTTP 403 (Kickstarter's bot/verification wall). No change; still needs an authenticated/browser session or an alternate archival source.
