...
- 2026-09-15 (audit pass): retried `src-004` directly; still HTTP 403 (Kickstarter's bot/verification wall). The same Wayback CDX query still returns zero captures, and no BGG thread quoting the reset-game/Gremlin Leader FAQ text was found this pass. Status unchanged; carrying to a future pass with the same alternate_source need.
